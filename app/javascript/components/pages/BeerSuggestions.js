...
const BeerSuggestions = ({current_user, suggested}) => {
  let myIBUSuggestions = suggested?.ibu_suggested.filter((user) => current_user.id === user.user_id);
  let myABVSuggestions = suggested?.abv_suggested.filter((user) => current_user.id === user.user_id)
  let styleSuggestions = suggested?.style_suggested.filter((user) => current_user.id === user.user_id)
